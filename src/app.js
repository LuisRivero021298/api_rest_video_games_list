...
app.use((req, res, next) => {
  ...
  res.header(
    ...
    "x-access-token, Authorization, X-API-KEY, Origin, X-Requested-With, Content-Type, Accept, Access-Control-Allow-Request-Method"
  );
...
let fileRoute = require("./routes/files.route.js");
